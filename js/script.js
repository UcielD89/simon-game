...
function inicializar_juego() {
    var boton_iniciar = document.getElementById("boton-iniciar");
    var boton_reiniciar = document.getElementById("boton-reiniciar");
    var boton_ranking = document.getElementById("boton-ranking");
    var boton_cerrar_modal = document.getElementById("cerrar-modal");
    var boton_cerrar_ranking = document.getElementById("cerrar-ranking");
    var botones_colores = document.querySelectorAll(".boton-color");
    ...
    boton_iniciar.addEventListener("click", manejar_inicio_juego);
    ...
    boton_cerrar_modal.addEventListener("click", manejar_cerrar_modal);
    ...
    for (var i = 0; i < botones_colores.length; i++) {
        botones_colores[i].addEventListener("click", manejar_click_color);
    }
}
...
function manejar_inicio_juego() {
    ...
    var pantalla_inicio = document.getElementById("pantalla-inicio");
...
function iluminar_boton(indice) {
    var botones = document.querySelectorAll(".boton-color");
...
function reproducir_sonido(indice) {
    var sonido = document.getElementById("sonido-" + indice);
    if (sonido) {
...
function actualizar_puntaje() {
    var puntaje_elemento = document.getElementById("puntaje");
    puntaje_elemento.textContent = secuencia_jugador.length;
}
// Actualiza el nivel actual mostrado en pantalla
function actualizar_nivel() {
    var nivel_elemento = document.getElementById("nivel");
...
function finalizar_juego(gano) {
    ...
    guardar_partida(nombre_jugador, puntaje_final, nivel_final, tiempo_transcurrido);
